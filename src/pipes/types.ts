...
export type GraphGeneratorFn<Id extends string, Metadata, Returned> = GeneratorFn<Graph<Id, Metadata>, Returned>

export type GraphNodeFn<Id extends string, Returned> = (node: GraphNode<Id>) => Returned

export type GraphNodeGeneratorFn<Id extends string, Returned> = GeneratorFn<GraphNode<Id>, Returned>

export type GraphNodeTupleFn<Id extends string, Returned> = (nodes: [GraphNode<Id>, GraphNode<Id>]) => Returned

export type GraphNodeTupleGeneratorFn<Id extends string, Returned> = GeneratorFn<[GraphNode<Id>, GraphNode<Id>], Returned>
...
export type GeneratorFn<Parameter, Returned> = (param: Parameter) => Generator<Returned>
