(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Searchable = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
"use strict";
...
/*#__PURE__*/
function () {
  function SearchableLunr(array) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck(this, SearchableLunr);
    ...
    _getId.set(this, {
      ...
      value: function value(id) {
        return _classPrivateFieldGet(this, _isArrayOfStrings) ? 'id' : id;
      }
    });
    ...
    _getKeys.set(this, {
      ...
      value: function value(keys) {
        return _is.default.array(keys) ? keys : [_classPrivateFieldGet(this, _id)];
      }
    });

    _getDocuments.set(this, {
      writable: true,
      value: function value() {
        var _this2 = this;

        return _classPrivateFieldGet(this, _isArrayOfStrings) ? _classPrivateFieldGet(this, _array).map(function (string) {
          return Object.defineProperty({}, _classPrivateFieldGet(_this2, _id), {
            value: string
          });
        }) : _classPrivateFieldGet(this, _array);
      }
    });
    ...
    _findItem.set(this, {
      ...
      value: function value(match) {
        ...
        return _classPrivateFieldGet(this, _isArrayOfStrings) ? _classPrivateFieldGet(this, _array).find(function (string) {
          return string === match.ref;
        }) : _classPrivateFieldGet(this, _array).find(function (object) {
          return object[_classPrivateFieldGet(_this3, _id)] === match.ref;
        });
      }
    });
    ...
    _classPrivateFieldSet(this, _keys, _classPrivateFieldGet(this, _getKeys).call(this, options.keys));
  ...
  return SearchableLunr;
}();

exports.default = SearchableLunr;

var _array = new WeakMap();

var _id = new WeakMap();

var _isArrayOfStrings = new WeakMap();

var _documents = new WeakMap();
