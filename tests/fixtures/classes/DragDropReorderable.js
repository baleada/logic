(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.DragDropReorderable = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
"use strict";
...
var DragDropReorderable =
/*#__PURE__*/
function () {
  function DragDropReorderable(elements, options) {
    _classCallCheck(this, DragDropReorderable);

    _eventNameDictionary.set(this, {
      writable: true,
      value: void 0
    });
    ...
    _getDependencyOptions.set(this, {
      ...
      value: function value(_ref) {
        var onDrag = _ref.onDrag,
            onDrop = _ref.onDrop,
            onCross = _ref.onCross,
            onReorder = _ref.onReorder,
            rest = _objectWithoutProperties(_ref, ["onDrag", "onDrop", "onCross", "onReorder"]);

        return rest;
      }
    });

    _constructDependency.set(this, {
      writable: true,
      value: function value() {
        var _this = this;

        var dependency = new _draggable.Sortable(this.elements, _classPrivateFieldGet(this, _dependencyOptions)),
            eventNames = ['drag', 'drop', 'cross', 'reorder'],
            eventHandlers = [_classPrivateFieldGet(this, _onDrag), _classPrivateFieldGet(this, _onDrop), _classPrivateFieldGet(this, _onCross), _classPrivateFieldGet(this, _onReorder)];
        eventNames.forEach(function (eventName, i) {
          var handler = eventHandlers[i],
              dependencyEventName = _classPrivateFieldGet(_this, _eventNameDictionary)[eventName];

          console.log(dependencyEventName);
          if (_is.default.function(handler)) dependency.on("sortable:".concat(dependencyEventName), function (evt) {
            return handler(evt);
          });
        });
        return dependency;
    ...
    _classPrivateFieldSet(this, _eventNameDictionary, {
      drag: 'start',
      drop: 'sort',
      cross: 'sorted',
      reorder: 'stop'
    ...
    _classPrivateFieldSet(this, _onDrag, options.onDrag);

    _classPrivateFieldSet(this, _onDrop, options.onDrop);

    _classPrivateFieldSet(this, _onCross, options.onCross);

    _classPrivateFieldSet(this, _onReorder, options.onReorder);

    _classPrivateFieldSet(this, _dependencyOptions, _classPrivateFieldGet(this, _getDependencyOptions).call(this, options)); // this.#dependencyOptions = options.sortableOptions


    _classPrivateFieldSet(this, _dependency, _classPrivateFieldGet(this, _constructDependency).call(this));
  }

  _createClass(DragDropReorderable, [{
    key: "destroy",
    value: function destroy() {
      var _classPrivateFieldGet2;

      (_classPrivateFieldGet2 = _classPrivateFieldGet(this, _dependency)).destroy.apply(_classPrivateFieldGet2, arguments);
    }
  }]);

  return DragDropReorderable;
}();

exports.default = DragDropReorderable;

var _eventNameDictionary = new WeakMap();

var _onDrag = new WeakMap();

var _onDrop = new WeakMap();

var _onReorder = new WeakMap();

var _onCross = new WeakMap();
...
var _constructDependency = new WeakMap();
},{"../utils/capitalize":2,"../utils/is":3,"../utils/toNodeList":4,"@shopify/draggable":5}],2:[function(require,module,exports){
"use strict";
