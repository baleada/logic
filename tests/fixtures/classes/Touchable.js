...
var _TouchableHammer = _interopRequireDefault(require("../wrappers/TouchableHammer"));
...
function () {
  function Touchable(element) {
    ...
    _classPrivateFieldSet(this, _dependency, new _TouchableHammer.default(this.element, _classPrivateFieldGet(this, _dependencyOptions)));
  }
  /* Public getters */
...
},{"../wrappers/TouchableHammer":5}],2:[function(require,module,exports){
"use strict";
...
/*#__PURE__*/
function () {
  function TouchableHammer(element) {
    var _options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck(this, TouchableHammer);

    _allowsSelect.set(this, {
      writable: true,
      value: void 0
    });
    ...
    _getCallbacks.set(this, {
      writable: true,
      value: function value(_ref) {
        var allowsSelect = _ref.allowsSelect,
            rest = _objectWithoutProperties(_ref, ["allowsSelect"]);

        return _objectSpread({}, rest);
      }
    });

    _getHammerOptions.set(this, {
      writable: true,
      value: function value(options) {
        var nonHammerOptions = ['allowsSelect'].concat(_toConsumableArray(Object.keys(_classPrivateFieldGet(this, _callbacks))));
        return Object.keys(options).reduce(function (hammerOptions, option) {
    ...
    _hammerConstructor.set(this, {
      ...
      value: function value(options) {
        ...
        options = (0, _resolveOptions.default)(options, _classPrivateFieldGet(this, _hammerApi));

        if (_classPrivateFieldGet(this, _allowsSelect)) {
          delete _classPrivateFieldGet(this, _dependency).defaults.cssProps.userSelect;
        }

        var instance = new (_classPrivateFieldGet(this, _dependency))(_classPrivateFieldGet(this, _element), options),
            events = Object.keys(_classPrivateFieldGet(this, _callbacks)).map(function (callback) {
          return callback.slice(2).toLowerCase();
        });
    ...
    _classPrivateFieldSet(this, _hammerApi, {
      directions: {
        none: 1,
        left: 2,
        right: 4,
    ...
    _classPrivateFieldSet(this, _dependency, _hammerjs.default);
  ...
  return TouchableHammer;
}();

exports.default = TouchableHammer;
